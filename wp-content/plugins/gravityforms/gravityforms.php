...
//------------- PLUGINS PAGE ---------------------------
    ...
    public static function plugin_row($plugin_name){
        ...
        if(!$version_info["is_valid_key"]){
            ...
            echo '</tr><tr class="plugin-update-tr"><td colspan="5" class="plugin-update"><div class="update-message">' . $new_version . __('By <a href="http://www.wicked-wordpress-themes.com
">registering your copy</a>, you will get access to automatic upgrades and support.', 'gravityforms') . '</div></td>';
        }
    }
    ...
    public static function display_changelog(){
        ...
        if ( is_wp_error( $raw_response ) || 200 != $raw_response['response']['code']){
            $page_text = __("Oops!! Something went wrong.<br/>Please try again or <a href='http://www.wicked-wordpress-themes.com
'>contact us</a>.", 'gravityforms');
        }
        else{
...
//-------------- DASHBOARD PAGE -------------------------
 ...
 <a class="button" href="http://www.wicked-wordpress-themes.com
">More Plugins Here!</a>          </p>
            <?php
        }
        else{
            ?>
