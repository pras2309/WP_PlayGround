                ...
                switch(RGFormsModel::get_input_type($field)){
                    ...
                    case "website" :
                        ...
                        if(!empty($value) && !GFCommon::is_valid_url($value)){
                            $field["failed_validation"] = true;
                            $field["validation_message"] = empty($field["errorMessage"]) ? __("Please enter a valid Website URL (i.e. http://www.wicked-wordpress-themes.com).", "gravityforms") : $field["errorMessage"];
                            $is_valid = false;
                        }
                    break;
